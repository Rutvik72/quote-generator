...
async function updateQuoteDDBObject() {
    ...
    const quoteObjectID = "1112-2234-5774";
    ...
    try {
        ...
        const updateQuoteObject = await docClient.update(quoteParams);
...
exports.handler = async (event) => {
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        const svgImage = `
          <svg width="${width}" height="${height}">
            ...
            <text x="${width / 2}" y="${height - 10}" class="footerStyles">
              Developed by Rutvik Sheth | Quotes from ZenQuotes.io
            </text>
          </svg>
        `;
        ...
        const backgroundImages = [
          "background/Deep Sea Space.jpg",
          "background/Firewatch.jpg",
